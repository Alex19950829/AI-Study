...
| **06 ~ 09** | **Agent 智能体架构** | 四大能力图谱、**P-A-O 控制循环**、**4大领域落地场景全景**、**AI Agent 黄金判定法则 (可行性3指标+控制权矩阵)** |
| **10** | **上下文窗口全景** | 上下文限制成因、主流模型对比与 **OpenClaw 架构治理** |
| **11 ~ 14** | **深度思考与推理模型** | **豆包/DeepSeek 推理演示**、**System 1 直觉 vs System 2 理性算力图景**、GRPO 强化学习、向量高熵激活与降本指南 |
| **15 ~ 17** | **模型参数量全景** | 浮点数物理本质、参数滑块试验、静态只读矩阵 $\times$ 动态输入 $X$ 算式 |
| **18** | **多模态底层原理** | 视觉 Token 3步转译与两大常见选型误区 |
