# 🤖 AI 从入门到精通 · 交�> 本项目将大模型底层原理、Prompt 提示词工程、Agent 智能体架构、RAG 知识库切片实操、LoRA 微调物理拆解与本地显存计算，系统性提炼并封装为一份**包含 33 页精美卡片与丰富交互组件的 HTML 全景 PPT 项目** (`ai_course_ppt.html`)。
...
- ⌨️ **极佳的演示操纵体验**：支持键盘左右方向键 `←` / `→` 翻页、`M` 键一键唤出全局 33 页大图目录。
