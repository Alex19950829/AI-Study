...
> - 🤖 **AI Agent 独立专题 PPT**：[ai_agent.html](file:///Users/a58/Downloads/%E5%AD%A6%E4%B9%A0/AI-Study/AI-Study/ai_agent.html) (精选 12 页 Lilian Weng 拓扑、P-A-O 循环演练、多工具并发编排、黄金判定法则、落地场景全景图、框架 Message List 存储位置、OpenClaw /compact 全流程、Claude Code 压缩与代码锁定、OpenClaw vs Claude Code 对比、4 大通用算法防线、7-3b 动态水箱及 MCP 架构解耦标准)
